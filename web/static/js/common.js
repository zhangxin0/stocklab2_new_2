...
var common_ops = {
    ...
    Load:function(){
        $("#stock_list").html("{% for item in hold_list%}<li><span><i class='fa fa-trash trash-list' id='trash'></i>股票:{{ item.hold_stock }}  选期:{{item.buy_date}}  买价:{{item.buy_price}}</span></li>{% endfor %}");
    }
};
